...
public class FeignClientsRegistrar implements BeanFactoryPostProcessor, EnvironmentAware, BeanClassLoaderAware, ResourceLoaderAware {
    ...
    public String getScanBasePackage() {
        return StringUtils.isBlank(scanBasePackage) ? SCAN_BASE_PACKAGE_DEFAULT : scanBasePackage;
    }
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory configurableListableBeanFactory) throws BeansException {
    	System.out.println("开始处理远程调用配置");
    	//优先注册到服务中心，feign后面在处理
    	client  = EurekaRegistry.getDiscoveryClientInstance();
