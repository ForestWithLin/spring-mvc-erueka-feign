...
public class EurekaRegistry {
    ...
    public synchronized static DiscoveryClient getDiscoveryClientInstance() {
        if(discoveryClient ==null){
            return new EurekaRegistry().getDiscoveryClient();
        }
     ...
     * @return
     */
    public DiscoveryClient initEurekaClient() {
...
//        ConfigurationManager.loadProperties(properties);
        ...
        System.out.println("instanceInfo:"+new Gson().toJson(instanceInfo));
